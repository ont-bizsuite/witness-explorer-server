...
public enum ErrorInfo {
     ...
     * invoke error
     */
    INVOKE_ERROR(61000, "FAIL, invoke contract error.", "调用合约失败"),
     ...
     * token expired
     */
    TOKEN_EXPIRED(62003, "Login expired.", "登录已过期"),
     ...
     */
    QR_CODE_ALREADY_SCANNED(61049, "qr code already scanned", "二维码已扫描"),
    /**
     * exceed download limit
     */
    EXCEED_DOWNLOAD_LIMIT(61050, "The purchase and download limit for this data set has exceeded.", "超过数据的允许下载次数"),

    /**
     * already audit
     */
    ALREADY_OPERATE(61002, "already operate.", "已操作");
